...
@section('content')
<h1 class="mb-3 mb-4 mt-4"><fieldset><legend>Atualizar Permissões.</legend></fieldset></h1>
    <div class="bg-light p-4 rounded">
        <h3>Função</h3>
        <div class="lead">Edite a função e gerencie as permissões.</div>
        <div class="container mt-4">
            ...
            <form method="POST" action="{{ route('roles.update', $role->id) }}">
                ...
                <a href="{{ route('roles.index') }}" class="btn btn-default">Volar</a>
            </form>
        </div>
